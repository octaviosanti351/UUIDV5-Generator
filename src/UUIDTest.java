...
public class UUIDTest {
    ...
    public static final UUID Q2_NAMESPACE = UUID.fromString("cd8bb591-fd1a-41a2-8924-211e572d227f");
    ...
    public static void main(String[] args) {
        String aString="ID_MATERIA: 1465";
        UUID test = nameUUIDFromNamespaceAndString(Q2_NAMESPACE, "1485");
        System.out.println(test);
        System.out.println(test.version());
        //25c18c8c-e7a5-5387-8cb9-b5b53f87a4c2
    }
